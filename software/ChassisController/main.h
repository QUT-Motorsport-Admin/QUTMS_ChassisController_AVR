...
#define HEARTBEAT_INV_ID		0x04000000
...
#define CAN_HEARTBEAT_TIME_INVERTERS (100)   // Defines the 10ms (100Hz) for the inverter trigger
#define CAN_HEARTBEAT_TIME_DATA (100)        // Defines the 10ms (100Hz) for the data trigger
#define CAN_HEARTBEAT_TIME_PDM (100)			// Defines the 50ms (20Hz) for the power trigger
#define CAN_HEARTBEAT_TIME_WHEEL (100)       // Defines the 50ms (20Hz) for the power trigger
#define CAN_HEARTBEAT_TIME_SHUTDOWN (100)   // Defines the 100ms (10Hz) for the power trigger
#define CAN_HEARTBEAT_TIME_AMU (100)			// Defines the 50ms (20Hz) for the power trigger
