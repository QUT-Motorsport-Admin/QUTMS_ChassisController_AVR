...
uint16_t INPUT_steeringAngle = 0;
uint16_t INPUT_accelerationPedal = 0;
uint16_t INPUT_brakePedal = 0;
uint16_t INPUT_brakePressureFront = 0;
uint16_t INPUT_brakePressureBack = 0;
